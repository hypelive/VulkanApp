...
const std::vector<Vertex> vertices = {
    ...
    {{-0.5f, 0.5f, 0.0f}, {0.7f, 0.7f, 0.0f}, {1.0f, 1.0f}},
...
private:
    ...
    {
        uint32_t extensionstCount;
        vkEnumerateDeviceExtensionProperties(device, nullptr, &extensionstCount, nullptr);

        std::vector<VkExtensionProperties> availableExtensions(extensionstCount);
        vkEnumerateDeviceExtensionProperties(device, nullptr, &extensionstCount, availableExtensions.data());
    ...
    VkSurfaceFormatKHR chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats)
    {
        ...
        // should rank every format really
    ...
    void createGraphicsPipeline()
    {
        ...
        // Depth and stencil can be configurated too
    ...
    void createTextureImage()
    {
        ...
        stbi_uc* pixels = stbi_load("textures/JainaArt.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
